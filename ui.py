...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(402, 623)
        MainWindow.setStyleSheet("background-color: #22222e")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setStyleSheet("background-color #22222\n"
"")
        self.centralwidget.setObjectName("centralwidget")
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(0, 0, 480, 221))
        self.frame.setStyleSheet("background-color: #fb5b5d")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.label = QtWidgets.QLabel(self.frame)
        self.label.setGeometry(QtCore.QRect(55, 0, 311, 41))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(80, 40, 231, 181))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("../../Pictures/35456.png"))
        self.label_2.setScaledContents(True)
        self.label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_2.setObjectName("label_2")
        self.input_amount = QtWidgets.QLineEdit(self.centralwidget)
        self.input_amount.setGeometry(QtCore.QRect(50, 250, 320, 60))
        font = QtGui.QFont()
...
"")
        ...
        self.input_currency.setGeometry(QtCore.QRect(50, 320, 320, 60))
        font = QtGui.QFont()
        font.setFamily("NewsGoth Lt BT")
        font.setPointSize(14)
...
"")
        ...
        self.output_currency.setGeometry(QtCore.QRect(50, 390, 320, 60))
        font = QtGui.QFont()
        font.setFamily("NewsGoth Lt BT")
        font.setPointSize(14)
...
"")
        ...
        self.output_amount.setGeometry(QtCore.QRect(50, 460, 320, 60))
        font = QtGui.QFont()
        font.setFamily("NewsGoth Lt BT")
        font.setPointSize(14)
...
"")
        ...
        self.pushButton.setGeometry(QtCore.QRect(50, 530, 320, 60))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(24)
        font.setBold(True)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Currency Conventer"))
